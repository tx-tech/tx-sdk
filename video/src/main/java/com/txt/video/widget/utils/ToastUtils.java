...
public final class ToastUtils {
    ...
    private static void show(final int resId, final int duration) {
        try {
            CharSequence text = TXSdk.getInstance().application.getText(resId);
            show(text, duration);
    ...
    private static void show(final int resId, final int duration, final Object... args) {
        try {
            CharSequence text = TXSdk.getInstance().application.getResources().getText(resId);
    ...
    private static void show(final CharSequence text, final int duration) {
        PermissionUtils.runOnUiThreadDelayed(new Runnable() {
            @SuppressLint("ShowToast")
            @Override
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(TXSdk.getInstance().application, text, duration);
    ...
    private static void show(final View view, final int duration) {
        PermissionUtils.runOnUiThreadDelayed(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.newToast(TXSdk.getInstance().application);
                iToast.setView(view);
