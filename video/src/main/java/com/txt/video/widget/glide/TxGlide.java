...
import com.txt.video.widget.glide.load.engine.prefill.BitmapPreFiller;
import com.txt.video.widget.glide.load.engine.prefill.PreFillType;
...
import com.txt.video.widget.glide.load.model.file_descriptor.FileDescriptorFileLoader;
import com.txt.video.widget.glide.load.model.file_descriptor.FileDescriptorResourceLoader;
import com.txt.video.widget.glide.load.model.file_descriptor.FileDescriptorStringLoader;
import com.txt.video.widget.glide.load.model.file_descriptor.FileDescriptorUriLoader;
import com.txt.video.widget.glide.load.model.stream.HttpUrlGlideUrlLoader;
import com.txt.video.widget.glide.load.model.stream.StreamByteArrayLoader;
import com.txt.video.widget.glide.load.model.stream.StreamFileLoader;
import com.txt.video.widget.glide.load.model.stream.StreamResourceLoader;
import com.txt.video.widget.glide.load.model.stream.StreamStringLoader;
import com.txt.video.widget.glide.load.model.stream.StreamUriLoader;
import com.txt.video.widget.glide.load.model.stream.StreamUrlLoader;
import com.txt.video.widget.glide.load.resource.bitmap.CenterCrop;
import com.txt.video.widget.glide.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import com.txt.video.widget.glide.load.resource.bitmap.FitCenter;
import com.txt.video.widget.glide.load.resource.bitmap.GlideBitmapDrawable;
import com.txt.video.widget.glide.load.resource.bitmap.ImageVideoDataLoadProvider;
import com.txt.video.widget.glide.load.resource.bitmap.StreamBitmapDataLoadProvider;
import com.txt.video.widget.glide.load.resource.drawable.GlideDrawable;
import com.txt.video.widget.glide.load.resource.file.StreamFileDataLoadProvider;
import com.txt.video.widget.glide.load.resource.gif.GifDrawable;
import com.txt.video.widget.glide.load.resource.gif.GifDrawableLoadProvider;
...
import com.txt.video.widget.glide.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import com.txt.video.widget.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
...
import com.txt.video.widget.glide.load.resource.transcode.TranscoderRegistry;
import com.txt.video.widget.glide.manager.RequestManagerRetriever;
import com.txt.video.widget.glide.module.TXGlideModule;
import com.txt.video.widget.glide.module.ManifestParser;
import com.txt.video.widget.glide.provider.DataLoadProvider;
import com.txt.video.widget.glide.provider.DataLoadProviderRegistry;
import com.txt.video.widget.glide.request.FutureTarget;
import com.txt.video.widget.glide.request.Request;
import com.txt.video.widget.glide.request.animation.GlideAnimation;
import com.txt.video.widget.glide.request.target.ImageViewTargetFactory;
import com.txt.video.widget.glide.request.target.Target;
import com.txt.video.widget.glide.request.target.ViewTarget;
 ...
 * maintaining an {@link Engine}, {@link BitmapPool}, {@link com.txt.video.widget.glide.load.engine.cache.DiskCache} and
 * {@link MemoryCache}.
 */
public class TxGlide {

    private static final String TAG = "TxGlide";
     ...
     *     {@link com.txt.video.widget.glide.load.ResourceDecoder}s and {@link com.txt.video.widget.glide.load.Transformation}s. Use
     ...
     * models. Typically the {@link RequestManager#using(com.txt.video.widget.glide.load.model.stream.StreamModelLoader)} or
     * {@link RequestManager#using(com.txt.video.widget.glide.load.model.file_descriptor.FileDescriptorModelLoader)} syntax is
     ...
     * </p>
     *
     * @see RequestManager#using(com.txt.video.widget.glide.load.model.file_descriptor.FileDescriptorModelLoader)
     * @see RequestManager#using(com.txt.video.widget.glide.load.model.stream.StreamModelLoader)
     *
