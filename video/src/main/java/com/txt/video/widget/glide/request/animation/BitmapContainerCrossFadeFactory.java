...
/**
 * A cross fade {@link GlideAnimation} for complex types that have a {@link Bitmap} inside
 ...
 * The new bitmap queried from the complex type is wrapped in a {@link BitmapDrawable}.
 *
 * @param <T> The type of the composite object that contains the {@link Bitmap} to be animated.
 */
