...
import com.txt.video.widget.glide.request.target.SquaringDrawable;
...
public class GlideDrawableImageViewTarget extends ImageViewTarget<GlideDrawable> {
    ...
    /**
     * {@inheritDoc}
     * If no {@link com.txt.video.widget.glide.request.animation.GlideAnimation} is given or if the animation does not set the
