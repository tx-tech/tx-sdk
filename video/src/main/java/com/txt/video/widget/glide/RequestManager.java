...
import com.txt.video.widget.glide.load.model.file_descriptor.FileDescriptorModelLoader;
import com.txt.video.widget.glide.load.model.stream.MediaStoreStreamLoader;
...
import com.txt.video.widget.glide.manager.ConnectivityMonitorFactory;
...
import com.txt.video.widget.glide.signature.ApplicationVersionSignature;
import com.txt.video.widget.glide.signature.MediaStoreSignature;
import com.txt.video.widget.glide.signature.StringSignature;
...
public class RequestManager implements LifecycleListener {
     ...
     *     so be wary of using
     *     {@link com.txt.video.widget.glide.GenericRequestBuilder#listener(com.txt.video.widget.glide.request.RequestListener)}} when
     ...
     * @see #load(Object)
     *
     * @param string A file path, or a uri or url handled by {@link com.txt.video.widget.glide.load.model.UriLoader}.
     */
     ...
     *     {@link com.txt.video.widget.glide.GenericRequestBuilder#signature(Key)} to mixin a signature
     ...
     *     {@link com.txt.video.widget.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     * @see #load(String)
     ...
     * {@link com.txt.video.widget.glide.load.model.UriLoader}.
     */
     ...
     * @see com.txt.video.widget.glide.GenericRequestBuilder#signature(Key)
     */
     ...
     * {@link com.txt.video.widget.glide.DrawableRequestBuilder#signature(Key)} instead. Scheduled to be
     ...
     *
     * <p>
     *  Falls back to the registered {@link com.txt.video.widget.glide.load.model.ModelLoaderFactory} registered for
     ...
     *     {@link com.txt.video.widget.glide.GenericRequestBuilder#signature(Key)} to mix in some
     ...
     *     {@link com.txt.video.widget.glide.GenericRequestBuilder#skipMemoryCache(boolean)}.
     * </p>
     *
     * @see #from(Class)
     * @see #loadFromMediaStore(Uri, String, long, int)
    ...
    /**
     * Returns a request builder that uses the {@link com.txt.video.widget.glide.load.model.ModelLoaderFactory} currently
     * registered for {@link File} to load the image represented by the given {@link File}. Defaults to
     * {@link com.txt.video.widget.glide.load.model.stream.StreamFileLoader.Factory} and
     * {@link com.txt.video.widget.glide.load.model.stream.StreamFileLoader} to load images from {@link File}s.
     *
     *  <p>
     ...
     * to {@link com.txt.video.widget.glide.load.model.stream.StreamResourceLoader.Factory} and
     * {@link com.txt.video.widget.glide.load.model.stream.StreamResourceLoader} to load resource id models.
     *
     * <p>
     ...
     * {@link com.txt.video.widget.glide.load.model.stream.HttpUrlGlideUrlLoader} and
     * {@link com.txt.video.widget.glide.load.data.HttpUrlFetcher} to load {@link URL} models.
     *
     * @see #from(Class)
     * @see #load(URL)
     *
     ...
     * {@link com.txt.video.widget.glide.GenericRequestBuilder#signature(Key)} instead. Scheduled to be
     * removed in Glide 4.0.
    ...
    /**
     * Returns a request builder that uses the {@link com.txt.video.widget.glide.load.model.ModelLoaderFactory}s currently
     ...
     * {@link com.txt.video.widget.glide.load.model.ModelLoaderFactory}s registered for the given model class for
     * {@link InputStream}s and {@link ParcelFileDescriptor}s to load a thumbnail from objects of
     * the given modelClass.
     *
     * <p>
     *     Note - you must use {@link com.txt.video.widget.glide.DrawableRequestBuilder#load(Object)}} to set a concrete model
     *     to be loaded before calling
     *     {@link com.txt.video.widget.glide.DrawableRequestBuilder#into(com.txt.video.widget.glide.request.target.Target)}. You may
     *     also use this object for repeated loads by calling <code>request.load(model).into(target)</code>. You may
     *     also adjust the options after calling {@link com.txt.video.widget.glide.DrawableRequestBuilder#load(Object)}} and/or
     *     {@link com.txt.video.widget.glide.DrawableRequestBuilder#into(com.txt.video.widget.glide.request.target.Target)}}. However,
     ...
     * {@link com.txt.video.widget.glide.load.data.DataFetcher} to convert the model to.
     */
