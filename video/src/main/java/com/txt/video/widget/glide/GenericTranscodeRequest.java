...
import com.txt.video.widget.glide.load.resource.transcode.UnitTranscoder;
...
public class GenericTranscodeRequest<ModelType, DataType, ResourceType>
    ...
    private static <A, T, Z, R> LoadProvider<A, T, Z, R> build(TxGlide glide, ModelLoader<A, T> modelLoader,
    ...
    GenericTranscodeRequest(Context context, TxGlide glide, Class<ModelType> modelClass,
                            ModelLoader<ModelType, DataType> modelLoader, Class<DataType> dataClass, Class<ResourceType> resourceClass,
