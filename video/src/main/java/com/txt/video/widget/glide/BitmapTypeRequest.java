...
import com.txt.video.widget.glide.load.resource.transcode.BitmapBytesTranscoder;
...
public class BitmapTypeRequest<ModelType> extends BitmapRequestBuilder<ModelType, Bitmap> {
    ...
    private static <A, R> FixedLoadProvider<A, ImageVideoWrapper, Bitmap, R> buildProvider(TxGlide glide,
