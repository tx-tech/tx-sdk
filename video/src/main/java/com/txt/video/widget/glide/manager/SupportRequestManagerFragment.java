 ...
 * {@link com.txt.video.widget.glide.RequestManager} that can be used to start, stop and manage Glide requests started for
...
public class SupportRequestManagerFragment extends Fragment {
    ...
    /**
     * Returns the current {@link com.txt.video.widget.glide.RequestManager} or null if none is set.
     */
