...
import com.txt.video.widget.glide.load.resource.gif.GifDrawableResource;

/**
 * An {@link com.txt.video.widget.glide.load.Transformation} that wraps a transformation for a {@link Bitmap}
