...
import com.txt.video.widget.glide.load.resource.bitmap.Downsampler;
import com.txt.video.widget.glide.load.resource.bitmap.FileDescriptorBitmapDecoder;
import com.txt.video.widget.glide.load.resource.bitmap.ImageVideoBitmapDecoder;
import com.txt.video.widget.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.txt.video.widget.glide.load.resource.bitmap.VideoBitmapDecoder;
...
import com.txt.video.widget.glide.request.animation.BitmapCrossFadeFactory;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
    ...
    /**
     * Transform images using {@link com.txt.video.widget.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
    ...
    /**
     * Transform images using {@link com.txt.video.widget.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(BitmapTransformation...)
     * @see #transform(Transformation[])
    ...
    /**
     * {@inheritDoc}
     * @see com.txt.video.widget.glide.request.animation.BitmapContainerCrossFadeFactory
     */
    @Override
