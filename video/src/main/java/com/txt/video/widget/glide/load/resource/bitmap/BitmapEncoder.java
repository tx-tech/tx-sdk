...
/**
 * An {@link com.txt.video.widget.glide.load.ResourceEncoder} that writes {@link Bitmap}s to
 * {@link OutputStream}s.
 *
 * <p>
...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
    ...
    @Override
    public String getId() {
        return "BitmapEncoder.com.txt.video.widget.glide.load.resource.bitmap";
    }
