...
import com.txt.video.widget.glide.load.engine.cache.DiskLruCacheWrapper;

import java.io.File;

/**
 * Creates an {@link com.txt.video.widget.glide.disklrucache.DiskLruCache} based disk cache in the specified disk cache
 * directory.
 * <p/>
