...
import com.txt.video.widget.glide.manager.RequestManagerFragment;
import com.txt.video.widget.glide.manager.SupportRequestManagerFragment;
...
/**
 * A collection of static methods for creating new {@link com.txt.video.widget.glide.RequestManager}s or retrieving existing
            ...
            synchronized (this) {
                if (applicationManager == null) {
                    ...
                    applicationManager = new RequestManager(context.getApplicationContext(),
                            new ApplicationLifecycle(), new com.txt.video.widget.glide.manager.EmptyRequestManagerTreeNode());
                }
            }
        }
