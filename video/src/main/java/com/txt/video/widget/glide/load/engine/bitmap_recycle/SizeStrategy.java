package com.txt.video.widget.glide.load.engine.bitmap_recycle;
...
class SizeStrategy implements com.txt.video.widget.glide.load.engine.bitmap_recycle.LruPoolStrategy {
    private static final int MAX_SIZE_MULTIPLE = 8;
    private final KeyPool keyPool = new KeyPool();
    private final com.txt.video.widget.glide.load.engine.bitmap_recycle.GroupedLinkedMap<Key, Bitmap> groupedMap = new com.txt.video.widget.glide.load.engine.bitmap_recycle.GroupedLinkedMap<Key, Bitmap>();
