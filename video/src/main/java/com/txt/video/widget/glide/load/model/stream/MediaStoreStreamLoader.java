...
import com.txt.video.widget.glide.load.data.MediaStoreThumbFetcher;
...
/**
 * An {@link com.txt.video.widget.glide.load.model.ModelLoader} that can use media store uris to open pre-generated thumbnails
 ...
 * it falls back to the wrapped {@link com.txt.video.widget.glide.load.model.ModelLoader} to load the
