...
import com.txt.video.widget.glide.request.target.BaseTarget;
import com.txt.video.widget.glide.request.target.SizeReadyCallback;
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    public interface PreloadModelProvider<U> {
        ...
        /**
         * Returns a non null {@link com.txt.video.widget.glide.GenericRequestBuilder} for a given item. Must exactly match
    ...
    /**
     * Returns a non null {@link com.txt.video.widget.glide.GenericRequestBuilder} for a given item. Must exactly match the
    ...
    private void cancelAll() {
        for (int i = 0; i < maxPreload; i++) {
            TxGlide.clear(preloadTargetQueue.next(0, 0));
        }
    }
