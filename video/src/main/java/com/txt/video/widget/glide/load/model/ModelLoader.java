 ...
 * @param <Y> The type of the data that can be used by a {@link com.txt.video.widget.glide.load.ResourceDecoder} to decode a
 *           resource.
 */
public interface ModelLoader<T, Y> {
     ...
     *              {@link com.txt.video.widget.glide.request.target.Target#SIZE_ORIGINAL} to indicate that the resource should
