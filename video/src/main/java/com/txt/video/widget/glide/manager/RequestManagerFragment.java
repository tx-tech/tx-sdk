...
/**
 * A view-less {@link Fragment} used to safely store an {@link com.txt.video.widget.glide.RequestManager} that
 * can be used to start, stop and manage Glide requests started for targets the fragment or activity this fragment is a
 * child of.
 *
 * @see com.txt.video.widget.glide.manager.SupportRequestManagerFragment
 * @see com.txt.video.widget.glide.manager.RequestManagerRetriever
 * @see com.txt.video.widget.glide.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
    ...
    private final com.txt.video.widget.glide.manager.ActivityFragmentLifecycle lifecycle;
    ...
    public RequestManagerFragment() {
        this(new com.txt.video.widget.glide.manager.ActivityFragmentLifecycle());
    }

    // For testing only.
    @SuppressLint("ValidFragment")
    RequestManagerFragment(com.txt.video.widget.glide.manager.ActivityFragmentLifecycle lifecycle) {
        this.lifecycle = lifecycle;
    }

    /**
     * Sets the current {@link com.txt.video.widget.glide.RequestManager}.
     *
    ...
    /**
     * Returns the current {@link com.txt.video.widget.glide.RequestManager} or null if none exists.
     */
