...
import com.txt.video.widget.glide.load.resource.bitmap.BitmapDecoder;
import com.txt.video.widget.glide.load.resource.bitmap.ImageHeaderParser;
import com.txt.video.widget.glide.load.resource.bitmap.RecyclableBufferedInputStream;
import com.txt.video.widget.glide.load.resource.bitmap.TransformationUtils;
import com.txt.video.widget.glide.request.target.Target;
import com.txt.video.widget.glide.util.ByteArrayPool;
import com.txt.video.widget.glide.util.ExceptionCatchingInputStream;
import com.txt.video.widget.glide.util.MarkEnforcingInputStream;
...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    ...
    public static final Downsampler AT_LEAST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_LEAST.com.txt.video.widget.glide.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler AT_MOST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_MOST.com.txt.video.widget.glide.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler NONE = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "NONE.com.txt.video.widget.glide.load.data.bitmap";
        }
    };
