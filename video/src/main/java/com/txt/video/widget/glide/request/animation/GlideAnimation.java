 ...
 * {@link com.txt.video.widget.glide.request.target.Target}s in across resource types. Targets that wrap views will be able to
...
public interface GlideAnimation<R> {
     ...
     * ({@link ViewAnimation},
     * {@link com.txt.video.widget.glide.request.animation.ViewPropertyAnimation} and animated
     * {@link Drawable}s).
     */
