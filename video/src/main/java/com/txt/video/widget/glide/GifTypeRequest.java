...
import com.txt.video.widget.glide.load.resource.transcode.GifDrawableBytesTranscoder;
...
public class GifTypeRequest<ModelType> extends GifRequestBuilder<ModelType> {
    ...
    private static <A, R> FixedLoadProvider<A, InputStream, GifDrawable, R> buildProvider(TxGlide glide,
