...
import com.txt.video.widget.glide.load.model.ImageVideoModelLoader;
...
import com.txt.video.widget.glide.provider.FixedLoadProvider;
 ...
 * {@link com.txt.video.widget.glide.load.resource.gif.GifDrawable}.
 */
public class DrawableTypeRequest<ModelType> extends DrawableRequestBuilder<ModelType> implements DownloadOptions {
    ...
    private static <A, Z, R> FixedLoadProvider<A, ImageVideoWrapper, Z, R> buildProvider(TxGlide glide,
    ...
    DrawableTypeRequest(Class<ModelType> modelClass, ModelLoader<ModelType, InputStream> streamModelLoader,
                        ModelLoader<ModelType, ParcelFileDescriptor> fileDescriptorModelLoader, Context context, TxGlide glide,
    ...
    /**
     * Attempts to always load the resource as a {@link com.txt.video.widget.glide.load.resource.gif.GifDrawable}.
     * <p>
     ...
     * </p>
     *
     * @return A new request builder for loading a {@link com.txt.video.widget.glide.load.resource.gif.GifDrawable}.
     */
