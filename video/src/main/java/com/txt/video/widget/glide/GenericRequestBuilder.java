...
import com.txt.video.widget.glide.load.MultiTransformation;
...
import com.txt.video.widget.glide.load.resource.UnitTransformation;
...
import com.txt.video.widget.glide.provider.ChildLoadProvider;
import com.txt.video.widget.glide.provider.LoadProvider;
import com.txt.video.widget.glide.request.FutureTarget;
import com.txt.video.widget.glide.request.GenericRequest;
import com.txt.video.widget.glide.request.Request;
import com.txt.video.widget.glide.request.RequestCoordinator;
import com.txt.video.widget.glide.request.RequestFutureTarget;
import com.txt.video.widget.glide.request.RequestListener;
import com.txt.video.widget.glide.request.ThumbnailRequestCoordinator;
import com.txt.video.widget.glide.request.animation.GlideAnimationFactory;
import com.txt.video.widget.glide.request.animation.NoAnimation;
import com.txt.video.widget.glide.request.animation.ViewAnimationFactory;
import com.txt.video.widget.glide.request.animation.ViewPropertyAnimation;
import com.txt.video.widget.glide.request.animation.ViewPropertyAnimationFactory;
import com.txt.video.widget.glide.request.target.PreloadTarget;
import com.txt.video.widget.glide.request.target.Target;
import com.txt.video.widget.glide.signature.EmptySignature;
 ...
 * @param <DataType> The data type that the resource {@link com.txt.video.widget.glide.load.model.ModelLoader} will provide that
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
     ...
     *     {@link com.txt.video.widget.glide.load.model.ModelLoader}, {@link ResourceDecoder}, and
     ...
     *
     * @see com.txt.video.widget.glide.load.resource.transcode.UnitTranscoder
     * @see com.txt.video.widget.glide.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @see com.txt.video.widget.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     *
     ...
     * impractical to return that size from {@link Target#getSize(com.txt.video.widget.glide.request.target.SizeReadyCallback)}.
     *
     ...
     * </p>
     *
     * @see com.txt.video.widget.glide.signature.StringSignature
     *
     ...
     *              {@link #override * (int, int)}} if previously called).
     *
     * @see TxGlide#clear(FutureTarget)
     *
