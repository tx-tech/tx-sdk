package com.txt.video.ui.trtc.feature;

import com.google.gson.Gson;
import com.tencent.trtc.TRTCCloudDef;
import com.txt.video.widget.utils.SPUtils;
...
public class VideoConfig implements Serializable {
    ...
    public void saveCache() {
        try {
            ...
            if (mSaveFlag) {
                Gson gson = new Gson();
                SPUtils.getInstance(PER_DATA).put(PER_DATA_PARAM, gson.toJson(this));
            }
        } catch (Exception e) {
        }
    }
    ...
    public void loadCache() {
        try {
            ...
            Gson gson = new Gson();
            VideoConfig setting    = gson.fromJson(json, VideoConfig.class);
