...
public class TRTCRemoteUserManager {
    ...
    private final TRTCRemoteUserIView mIView;  //与界面相关的回调
    ...
    public TRTCRemoteUserManager(TRTCCloud trtcCloud, TRTCRemoteUserIView iView, boolean isCustomCaptureAndRender) {
