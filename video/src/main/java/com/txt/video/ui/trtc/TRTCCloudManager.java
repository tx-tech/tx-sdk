...
import com.txt.video.ui.trtc.feature.AudioConfig;
import com.txt.video.ui.trtc.feature.MoreConfig;
import com.txt.video.ui.trtc.feature.PkConfig;
import com.txt.video.ui.trtc.feature.VideoConfig;
 ...
 * 1. 通过 {@link TRTCCloudIView} 接口和界面进行联系，如果您编写的界面需要监听sdk的一些变化，可以通过 {@link TRTCCloudManager#setViewListener} 设置 listener
...
public class TRTCCloudManager {
    ...
    /**
     * 接收模式
     * 可以参考 {@link TRTCCloudManager(boolean, int)} 中对 mReceivedMode 中的操作
    ...
    public void setViewListener(TRTCCloudIView IView) {
        mIView = IView;
    }
