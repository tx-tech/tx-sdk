package com.txt.video.ui.trtc.videolayout.list.page;
...
import com.txt.video.ui.trtc.videolayout.list.MeetingPageLayoutManager;
...
public class PagerSnapHelper extends SnapHelper {
    ...
    public int[] calculateDistanceToFinalSnap(@NonNull RecyclerView.LayoutManager layoutManager,
        ...
        TxLogUtils.e("findTargetSnapPosition, pos = " + pos);
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager,
        ...
        TxLogUtils.e("findTargetSnapPosition, velocityX = " + velocityX + ", velocityY" + velocityY);
        ...
        TxLogUtils.e("findTargetSnapPosition, target = " + target);
        return target;
    }
    ...
    public boolean onFling(int velocityX, int velocityY) {
        ...
        TxLogUtils.e("minFlingVelocity = " + minFlingVelocity);
